...
public class BetaReaderService {
    ...
    public List<BetaReaderIndexUnit> searchBetaReaders(String genre, Double latitude, Double longitude) {
        ...
        return elasticsearchTemplate.queryForList(query, BetaReaderIndexUnit.class);
    }
}
